...
$(function () {
    var i = 1;
    var j = 1;
    $("#addRowCustodyTrans").click(function () {
        ...
        if (isValid) {
            ...
            $.get("/CustodyTransfer/GetItemList", { ID: 0 }, function (data) {
                $("#ItemList").empty();
            ...
            $.get("/CustodyTransfer/GetItemGroupList", function (data) {
            ...
            $.get("/CustodyTransfer/GetUintList", { ID: 0 }, function (data) {
                $("#UnitList").empty();
    ...
    $("#submit").click(function () {
        ...
        var PurchaseType = $('#CustodyTransferTypeList').val();
        ...
        //    isValid = false;
        //}
        //if (document.getElementById("CustodyTransferTypeList").selectedIndex == 0) {
        ...
        if (isValid) {
            ...
            $.ajax({
                type: 'POST',
                url: '/CustodyTransfer/AddCustodyTransfer',
