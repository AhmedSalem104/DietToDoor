...
$(function () {
    ...
    $("#addRowRec").click(function () {
        ...
        if (isValid) {
            ...
            $('#UnitList,#ItemList,#Qty,#Price,#Total,#Disper,#DisValue,#Net , #NotesD', $newRow).attr('disabled', false);
            $('#UnitList,#ItemList,#Qty,#Price,#Total,#Disper,#DisValue,#Net, #NotesD', $newRow).removeAttr('id');
    ...
    $("#submit").click(function () {
        ...
        if (isValid) {
            var data = {
                ...
                StoresKeepersId: $("#StoresKeepers").val(),
                StoreBigManagers: $("#EmployeeList").val(),
                RecipientId: $("#RecipientId").val(),
                Attachments: $("#Attachments").val(),
                PagesCount: $("#PagesCount").val(),
                RecordNo: $("#RecordNo").val(),
                CheckDocNo: $("#CheckDocNo").val(),
                CheckDate: $("#CheckDate").val(),
                RowsCount: $("#RowsCount").val(),

                TempReceiveNo: $("#TempReceiveNo").val(),
                TempReceiveDate: $("#TempReceiveDate").val(),
                InternalDepartmentsId: $("#InternalDepartments").val(),
                ShippingDate: $("#ShippingDate").val(),
                ShippingDocNo: $("#ShippingDocNo").val(),
                RowsCount: $("#RowsCount").val(), 
                TotaleItemDis: $("#TotaleItemDis").val(),
                RecieveNoteTotal: $("#TotalBeforeDis").text(),
                InvoiceDisPer: $("#TotalDisper").val(), 
                ReceiveNoteDisValue: $("#TotalDis").val(),
            ...
            $.ajax({
                type: 'POST',
                url: '/RecieveNote/AddRecieveNote',
