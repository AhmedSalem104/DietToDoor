    ...
    $("#submit").click(function () {
        ...
        if (isValid) {
            var data = {
                ...
                DemAndBranchId: $("#DemAndBranchId").val(),
                //DropTypeTransferCustodayId: $("#DropTypeTransferCustodayList").val(),               
                OwnerId: $("#OwnerId").val(),
            ...
            $.ajax({
                type: 'POST',
                url: '/TransferCustoday/AddTransferCustoday',
