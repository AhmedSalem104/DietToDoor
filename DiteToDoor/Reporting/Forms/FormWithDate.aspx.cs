...
{
    public partial class FormWithDate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["DataSet"] != null && Session["query"] != null)
            {
                ...
                using (ApplicationDbContext db = new ApplicationDbContext())
                {
                    ...
                    object[] parameter = new object[6] { FromDate, ToDate, SafeName,TRXName,BrancheName,LoginName };
                    ...
                    param[3] = new ReportParameter("TRXName", Convert.ToString(parameter[3]), true);
