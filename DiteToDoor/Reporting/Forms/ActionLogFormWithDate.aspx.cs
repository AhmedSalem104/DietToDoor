...
{
    public partial class ActionLogFormWithDate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["DataSet"] != null && Session["query"] != null)
            {
                ...
                using (ApplicationDbContext db = new ApplicationDbContext())
                {
                    ...
                    object[] parameter = new object[6] { FromDate, ToDate,Action, UserName, BrancheName,LoginName };
                    ...
                    param[2] = new ReportParameter("Action", Convert.ToString(parameter[2]), true);
                    param[3] = new ReportParameter("UserName", Convert.ToString(parameter[3]), true);
                    ...
                    ReportViewer20.LocalReport.ReportPath = Server.MapPath(PathStr);
                    ReportDataSource Rds = new ReportDataSource(DataSetStr, queryStr);
                    ReportViewer20.LocalReport.DataSources.Add(Rds);
                    ReportViewer20.LocalReport.Refresh();
                    ReportViewer20.LocalReport.SetParameters(param);
                    ReportViewer20.AsyncRendering = false;
                    ReportViewer20.SizeToReportContent = true;
                    ReportViewer20.ZoomMode = ZoomMode.FullPage;
