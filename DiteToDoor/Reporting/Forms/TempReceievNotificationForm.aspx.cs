...
{
    public partial class TempReceievNotification : System.Web.UI.Page
    {
        ...
        private void BindReport()
        {
            try
            {
                ...
                this.ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { p1, p2 });                //ReportParameter p2 = new ReportParameter("ReportParameter2", Edate.ToString());
