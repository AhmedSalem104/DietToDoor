...
$(function () {
    ...
    $("#addRowPur").click(function () {
        ...
        if (isValid) {
            ...
            $('#UnitList,#ItemList,#Qty,#Price,#Total,#Disper,#DisValue,#Net , #ItemCostt', $newRow).attr('disabled', false);
            $('#UnitList,#ItemList,#Qty,#Price,#Total,#Disper,#DisValue,#Net, #ItemCostt', $newRow).removeAttr('id');
    ...
    $("#submit").click(function () {
        ...
        if (isValid) {
            var data = {
                PurchaseINVNo: $("#PurchaseINVNo").val(),
                ...
                PurchaseINVTotal: $("#TotalBeforeDis").text(), 
