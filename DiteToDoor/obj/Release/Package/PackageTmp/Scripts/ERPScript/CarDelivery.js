...
$(function () {
    var i = 1;
    var j = 1;
    $("#addRowCarDelivery").click(function () {
    ...
    $("#addRowCarDeliveryy").click(function () {
    ...
    $("#submit").click(function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                type: 'POST',
                url: '/CarDelivery/AddCarDelivery',
                ...
                success: function (data) {
                    if (data.status) {
                        ...
                        location.href = "/CarDelivery/Index";
    ...
    $("#edit").click(function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                type: 'POST',
                url: '/CarDelivery/UpdateCarDelivery',
                data: JSON.stringify(data),
                contentType: 'application/json',
                success: function (data) {
                    if (data.status) {
