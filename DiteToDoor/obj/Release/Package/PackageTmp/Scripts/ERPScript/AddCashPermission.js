...
$(function () {
    $("#add").click(function () {
        ...
        if (isValid) {
            ...
            $.get("/StoreCashingPermission/GetItemGroupList", function (data) {
            ...
            $.get("/StoreCashingPermission/GetItemList", { ID: 0 }, function (data) {
                $("#ItemListPopUp").empty();
            ...
            $.get("/StoreCashingPermission/GetUintList", { ID: 0 }, function (data) {
                $("#UnitList").empty();
    ...
    $("#submit").click(function () {
        ...
        if (isValid) {
            var data = {
                CashPermissionNo: $("#SalesINVNo").val(),
                CashPermissionDate: $("#SalesINVDate").val(),
            ...
            $.ajax({
                type: 'POST',
                url: '/StoreCashingPermission/AddPermission',
...
$("#update").click(function () {
    ...
    if (isValid) {
        ...
        $.ajax({
            type: 'POST',
            url: '/StoreCashingPermission/updatePermission',
            data: JSON.stringify(data),
            contentType: 'application/json',
            success: function (data) {
                if (data.status) {
