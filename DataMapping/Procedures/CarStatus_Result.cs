...
{
    public class CarStatus_Result
    {
      
        public int CarId { get; set; }

        public int CarId_Old { get; set; }
        ...
        public int? CarDriversType { get; set; }    
        public int? CarDrivers_CarId { get; set; }  
        public int? CarDrivers_DriverID { get; set; }
        ...
        public bool? CarDriversIsDeleted { get; set; }  
